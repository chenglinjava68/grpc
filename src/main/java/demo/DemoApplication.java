...
public class DemoApplication {
    ...
    CustomerRepository customerRepository() {
        ...
        Arrays.asList(
                customer(1, "Chris", "Richardson", Arrays.asList("chenlinjava@qq.com")),
                customer(2, "Josh", "Long", Arrays.asList("cljava@qq.com")),
                customer(3, "Matt", "Stine", Arrays.asList("cljava68@qq.com")),
                customer(4, "Russ", "Miles", Arrays.asList("chenglin@qq.com"))
